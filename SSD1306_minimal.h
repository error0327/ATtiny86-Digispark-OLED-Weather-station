/*
  ...
  under the terms of BSD license, check license.txt for more information.
	...
	21.1.2018
	Obada Abu Alhiga : Function "printStringInt" was added this will allow printing a sting and a number in teh same line .
	Full project under : https://github.com/error0327/hit-arena
*/
...
class SSD1306_Mini {
  ...
  public:
    ...
    // print a string to the screen
    void printStringInt( char * pText,int integer );
