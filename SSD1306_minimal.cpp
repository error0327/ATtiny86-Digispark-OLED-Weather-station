...
void SSD1306_Mini::printStringInt( char * pText,int integer ){
  unsigned char i;
  unsigned char len = strlen( pText );
  
  //char *integer_temp = itoa(integer);
  char cstr[16];
  char *integer_temp = itoa(integer, cstr, 10);


  
  unsigned char len2 = strlen( integer_temp );
